	...
	m_project(project)
{
	...
	pageActors = new DatabaseSplitWidget<lcf::rpg::Actor, ActorWidget>(m_projectDataCopy, database.actors, this);
	pageClasses = new DatabaseSplitWidget<lcf::rpg::Class, ClassWidget>(m_projectDataCopy, database.classes, this);
	pageSkills = new DatabaseSplitWidget<lcf::rpg::Skill, SkillWidget>(m_projectDataCopy, database.skills, this);
	pageItems = new DatabaseSplitWidget<lcf::rpg::Item, ItemWidget>(m_projectDataCopy, database.items, this);
	pageEnemies = new DatabaseSplitWidget<lcf::rpg::Enemy, EnemyWidget>(m_projectDataCopy, database.enemies, this);
	pageEnemyGroups = new DatabaseSplitWidget<lcf::rpg::Troop, EnemyGroupWidget>(m_projectDataCopy, database.troops, this);
	pageAttributes = new DatabaseSplitWidget<lcf::rpg::Attribute, AttributeWidget>(m_projectDataCopy, database.attributes, this);
	pageStates = new DatabaseSplitWidget<lcf::rpg::State, StateWidget>(m_projectDataCopy, database.states, this);
	pageBattleAnimations = new DatabaseSplitWidget<lcf::rpg::Animation, BattleAnimationWidget>(m_projectDataCopy, database.animations, this);
	pageBattleAnimations2 = new DatabaseSplitWidget<lcf::rpg::BattlerAnimation, BattleAnimation2Widget>(m_projectDataCopy, database.battleranimations, this);
	pageBattleScreen = new BattleScreenWidget(m_projectDataCopy, this);
	pageTerrain = new DatabaseSplitWidget<lcf::rpg::Terrain, TerrainWidget>(m_projectDataCopy, database.terrains, this);
	pageChipset = new DatabaseSplitWidget<lcf::rpg::Chipset, ChipSetWidget>(m_projectDataCopy, database.chipsets, this);
	pageCommonevents = new DatabaseSplitWidget<lcf::rpg::CommonEvent, CommonEventWidget>(m_projectDataCopy, database.commonevents, this);
	pageSwitches = new DatabaseSplitWidget<lcf::rpg::Switch, SwitchWidget>(m_projectDataCopy, database.switches, this);
	pageVariables = new DatabaseSplitWidget<lcf::rpg::Variable, VariableWidget>(m_projectDataCopy, database.variables, this);

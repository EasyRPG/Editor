...
class Start : public Binding::BindingBase {
	Q_OBJECT
	Q_PROPERTY(int32_t party_map_id READ party_map_id CONSTANT)
	...
	Q_PROPERTY(int32_t boat_map_id READ boat_map_id CONSTANT)
	...
	Q_PROPERTY(int32_t ship_map_id READ ship_map_id CONSTANT)
	...
	Q_PROPERTY(int32_t airship_map_id READ airship_map_id CONSTANT)
